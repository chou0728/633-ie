...
<script lang="ts">
    ...
    @Component
    export default class DialogSafePassword extends Vue {
        ...
        public hide(event: any) {
            const dialog = document.getElementById('model-dialog-safe-password')
        ...
        private doSubmit() {
            ...
            this.error.password = ''
            if (this.form.old_password === '' && this.member.member_safe_password !== '') {
            ...
            this.loading = true
            _doSubmit('/member/safePassword', this.form).then(response => {
